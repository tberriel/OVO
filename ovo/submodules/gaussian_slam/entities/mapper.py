...
from .datasets import TUM_RGBD, BaseDataset, ScanNet
from .gaussian_model import GaussianModel
from .logger import Logger
from .losses import isotropic_loss, l1_loss, ssim
from ..utils.mapper_utils import (calc_psnr, compute_camera_frustum_corners,
...
from ..utils.utils import (get_render_settings, np2ptcloud, np2torch,
                             render_gaussian_model, torch2np)
from ..utils.vis_utils import *  # noqa - needed for debugging
...
class Mapper(object):
    ...
    def map(self, frame_id: int, estimate_c2w: np.ndarray, gaussian_model: GaussianModel, is_new_submap: bool) -> dict:
        ...
        _, gt_color, gt_depth, _ = self.dataset[frame_id][:4]
